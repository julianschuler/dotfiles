...
abbr -a gch 'git cherry-pick'
abbr -a gcl 'git clone'
abbr -a gclr 'git clone --recursive'
abbr -a gco 'git checkout'
abbr -a gcod 'git checkout -d'
abbr -a gf 'git fetch --prune'
abbr -a gi 'git diff'
abbr -a gis 'git diff --staged'
abbr -a gl 'git log'
abbr -a glo 'git log --oneline --decorate --all --graph'
abbr -a glp 'git log -p'
abbr -a gls 'git log --stat'
abbr -a gm 'git merge'
abbr -a gms 'git merge --squash'
abbr -a gr 'git restore -S'
...
abbr -a gu 'git push'
abbr -a gud 'git push -d'
abbr -a guf 'git push --force-with-lease'
abbr -a gul 'git pull'
abbr -a guu 'git push -u'

# systemd
abbr -a sc 'sudo systemctl'
abbr -a scd 'sudo systemctl daemon-reload'
abbr -a scs 'sudo systemctl status'
abbr -a sca 'sudo systemctl start'
abbr -a sco 'sudo systemctl stop'
abbr -a scu 'systemctl --user'
abbr -a scud 'systemctl --user daemon-reload'
abbr -a scus 'systemctl --user status'
abbr -a scua 'systemctl --user start'
abbr -a scuo 'systemctl --user stop'
abbr -a jc 'sudo journalctl -xeu'
abbr -a jcf 'sudo journalctl -xfeu'
abbr -a jcu 'journalctl --user -xeu'
abbr -a jcuf 'journalctl --user -xfeu'
